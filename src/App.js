...
import { BrowserRouter } from 'react-router-dom'; // Chamando broserRouter aqui para ele envolver todos os soutros módulos, para facilitar o uso das rotas em toda a apicação
